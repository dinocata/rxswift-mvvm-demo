...
final class CoreDataStackImpl: CoreDataStack {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: Constants.Config.persistentContainerName)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: Constants.Config.persistentContainerName,
                                       withExtension: "momd")!
...
final class MockCoreDataStack: CoreDataStack {
    ...
    var context: NSManagedObjectContext {
        if #available(iOS 10.0, *) {
            ...
            fatalError("Mocked Core Data stack can only be used in iOS 10 or higher.")
        }
    }
